...
function init (tid, cid, uid, options) {
  return new Visitor(tid, cid, uid, options);
}


var Visitor = module.exports.Visitor = function (tid, cid, uid, options, context) {
...
Visitor.prototype = {
	...
	_withContext: function (context) {
		var visitor = new Visitor(this.tid, this.cid, this.uid, this.options, context);
